 ...
 * The Class Tarxeta.
 */
public class Tarxeta extends ContaBancaria implements Comparator<ContaBancaria>{
...
class ListarPorSaldo implements Comparator<Tarxeta>{

    @Override
    public int compare(Tarxeta o1, Tarxeta o2) {
